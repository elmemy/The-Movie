...
class SortPresenterImplementation: SortPresenter {
    ...
    func getPopularMovies() {
        ...
        self.delegatetypeMovies?.getTypeMovies(type: "PopularMovies")
    }
    
    func getTopRated() {
        self.view?.fetchingDataSuccess()
        self.delegatetypeMovies?.getTypeMovies(type: "TopRated")
    }
    
    
    func getMyFav() {
        self.view?.fetchingDataSuccess()
        self.delegatetypeMovies?.getTypeMovies(type: "MyFav")
